...
const Layout = ({ children }) => {
  ...
  const backgroundImg = data.allFile.edges.filter(img => img.node.absolutePath.includes("backgrounds/01.png"))[0].node.absolutePath;
  ...
  return (
    <>
      <div className="bgded" style={{backgroundImage: `url('${backgroundImg}')`}}>
          ...
          <div className="bgded overlay row4" style={{backgroundImage: `url('${backgroundImg}')`}}>
            <footer id="footer" className="hoc clear"> 
              ...
              <div className="group">
                ...
                <div className="one_quarter">
                  <h6 className="heading">Magna nulla ultricies nulla</h6>
                ...
                <div className="one_quarter">
                  <h6 className="heading">Id eleifend tellus erat</h6>
